...
// KitchenService interface: the swap point.
// Both RealKitchenService and ChaosKitchenService implement this.
type KitchenService interface {
	Prepare(orderID int, drink string) (*Preparation, error)
}

// RealKitchenService always works.
...
// ChaosKitchenService randomly injects failures.
